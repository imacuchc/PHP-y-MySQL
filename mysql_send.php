...
*Desc:      Programa PHP que envía una consulta SQL al
*           servidor MySQL y muestra los resultados.
*/
echo "<html>
...
echo "<hr><br>
	<form action='{$_SERVER['PHP_SELF']}' method='POST'>
		...
		<input type='submit' name='queryButton' 68 Part II: My SQL Database value='Edit Query'>
	</form>";
exit();
}
...
method="POST">
<table>
	<tr><td style='text-align: right; font-weight: bold'>Type in database name</td>
		<td><input type="text" name="database" value=<?php echo @$_POST['database'] ?> ></td>
	</tr>
	<tr><td style='text-align: right; font-weight: bold' valign="top">Type in SQL query</td>
